/* 
 * Control SRF04 ultrasonic range finder and ADXL345 accelerometer.
 *
 * Hacking away, starting from code posted by joan on the following thread.
 * 
 * http://www.raspberrypi.org/forums/viewtopic.php?t=12503
 */

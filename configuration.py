...
device_list = [
               ...
               led.LEDIndicatorLight(control_pin=8,name="system_up_light"),
               led.LEDIndicatorLight(control_pin=12,name="attention_light",frequency=1,duty_cycle=50),
               led.LEDIndicatorLight(control_pin=10,name="client_connected_light"),
]
